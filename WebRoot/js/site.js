    ...
    var that = {
      ...
      redraw:function(){
        ...
        sys.eachEdge(function(edge, p1, p2){
          ...
          var wd = Math.max(20, 20+gfx.textWidth(edge.data.label)) 
//	          var wd = Math.min(50, 10+gfx.textWidth(edge.data.label))
	          gfx.rect((p1.x + p2.x)/2-wd/2, (p1.y + p2.y)/2-8, wd, 20, 4, {fill:"#b2b19d"})
	          gfx.text(edge.data.label, (p1.x + p2.x)/2, (p1.y + p2.y)/2+9, {color:"#ffffff", align:"center", font:"Arial", size:12})
        })
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['概念','code','docs','demos','introduction']) >=0 ){
  ...
  $(document).ready(function(){
   ...
   var params={} 
    ...
    $.ajax({
		...
		success : function(data,textStatus) {
			...
			datan=data.params.nodes;
			datae=data.params.edges
   ...
   // alert(params.nodes);
    /*
    var datan={ aa:{"color":"green", shape:"dot", alpha:"1"}, 
            ...
            reference:{color:CLR.doc, shape:"dot",alpha:1, link:'#reference'},
            introduction:{color:CLR.doc, shape:"dot",alpha:1, link:'#introduction'},
  ...
  //  var datan= {酒吧:{"color":"green", shape:"dot", alpha:"1"} }
 //   var datan={ 酒吧:{"color":"green", shape:"dot", alpha:"1"}, 
//  	      
 //           酒:{color:CLR.branch, shape:"dot", alpha:1} 
//            啤酒:{color:CLR.demo, shape:"dot", alpha:1},
//            吕子乔:{color:CLR.demo, shape:"dot", alpha:1},
//            曾小贤:{color:CLR.demo,shape:"dot", alpha:1},
//
//            薯片:{color:CLR.branch, shape:"dot", alpha:1}, 
//            零食:{color:CLR.doc, shape:"dot",alpha:1},
//            青年:{color:CLR.doc, shape:"dot",alpha:1},
//
//            孙艺洲:{color:CLR.branch, shape:"dot", alpha:1},
//            陈赫:{color:CLR.code, shape:"dot", alpha:1},
//            电视剧:{color:CLR.code, shape:"dot", alpha:1},
//            爱情公寓:{color:CLR.code, shape:"dot", alpha:1}
//          }
    
//    var datan=params.nodes
    		
//    		{"aa":{"alpha":"1","color":"red","shape":"dot"},
//    		"bb":{"alpha":"1","color":"yellow","shape":"dot"},
//    		"cc":{"alpha":"1","color":"green","shape":"dot"}
//    		}
//    
